...
def get_dataloader(model_name, eval_length, target_dim, seed=1, nfold=None, batch_size=16, missing_ratio=0.1, scaling_flag = False, retrain_id = ''):
	...
	active_dataset = Dataset(model_name=model_name, target_dim=target_dim, eval_length=eval_length, missing_ratio=missing_ratio, seed=seed, idx='active', scaling_flag=scaling_flag, train_ds = train_dataset)
